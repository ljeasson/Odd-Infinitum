...
augments[2,0] = obj_Emergency_Repair_Inv;
augments[3,0] = obj_Emergency_Supercharge_Inv;
augments[0,1] = obj_Supply_Drop_Inv;
augments[1,1] = obj_Close_Call_Stasis_Inv;
augments[2,1] = obj_Close_Call_Supercharge_Inv;
augments[3,1] = obj_Tortise_Inv;
augments[0,2] = obj_Buckler_Repair_Inv;
augments[1,2] = obj_Buckler_Reload_Inv;
augments[2,2] = obj_Auto_Counter_Inv;
augments[3,2] = obj_Heat_Absorption_Inv;
